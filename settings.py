...
routes = [
	...
	webapp2.Route('/'                              , handler='dagkot.ViewAll'      , name='home'),
	webapp2.Route('/next/<page:\d+>'               , handler='dagkot.ViewAllNext'  , name='home_next'),
	webapp2.Route('/mine'                          , handler='dagkot.ViewMine'     , name='mine'),
	webapp2.Route('/mine/next/<page:\d+>'          , handler='dagkot.ViewMineNext' , name='mine_next'),
